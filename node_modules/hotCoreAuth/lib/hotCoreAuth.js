...
hooks.init = function( done ){
  ...
  var declareStore = hotCoreJsonRestStores.declareStore;
  ...
  var UserStrategies = declareStore( Store, {
  ...
  var AuthStrategies = declareStore( BasicStore, {
  ...
  var UserLogins = declareStore( BasicStore, {
