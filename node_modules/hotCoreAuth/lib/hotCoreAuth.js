    ...
    if( err ){
      ...
      stores.UsersStrategies = declare( HotStore, {
        ...
        schema: new HotSchema({
          ...
          strategyId:  { type: 'string', searchable: true, required: true, trim: 30 }  ,
          field1:      { type: 'string', searchable: true, required: false, trim: 255 } ,
          field2:      { type: 'string', searchable: true, required: false, trim: 255 } ,
          field3:      { type: 'string', searchable: true, required: false, trim: 255 } ,
          field4:      { type: 'string', searchable: true, required: false, trim: 255 } ,
        }),
    
        onlineSearchSchema: new HotSchema({
          // No search field is allowed via JsonRest request
          /*
          strategyId: { type: 'string', searchable: true, trim: 30 }  ,
        ...
        checkPermissionsGetQuery: function( params, body, options, cb ){
          ...
          // Cannot filter by fields, since they are private fields
