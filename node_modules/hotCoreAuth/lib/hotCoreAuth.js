...
hooks.init = function( done ){
  ...
  var UserStrategies = exports.UserStrategies = declare( Store, {
    ...
    // Don't allow deletion of the very last auth method, or the user will be locked out
...
*/
      ...
      */
      ...
      switch( responseType ){
        ...
        case 'redirect-opener':
          console.log("METHOD: CLOSE-OPENER");
          if( ! user && typeof( profile.message) !== 'undefined'  ){
  ...
  if( typeof( hotplate.get('hotCoreAuth/strategies' )) === 'object' ){
    Object.keys( hotplate.get('hotCoreAuth/strategies' )).forEach( function( strategyName ) {
      ...
      strategyMaker( strategyData, makeResponder, exports.AuthStrategies, exports.Users, exports.UserStrategies, exports.UserLogins );
    });
...
hooks.stores = function( done ){
 ...
 /*
    userStrategies     : { target: '/user/:userId/strategies/',        idProperty: '_id', sortParam: 'sortBy', },
