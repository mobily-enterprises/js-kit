...
exports = module.exports = function( strategyConfig,  makeResponder, AuthStrategies, Users, UserStrategies, UserLogins ) {
  ...
  hotplate.app.get('/auth/manager/facebook', passport.authenticate('facebook-manager'));
  hotplate.app.get('/auth/manager/facebook/callback', function( req, res, next) {
  ...
  hotplate.app.get('/auth/signin/facebook', passport.authenticate('facebook-signin'));
  hotplate.app.get('/auth/signin/facebook/callback', function( req, res, next) {
  ...
  hotplate.app.get('/auth/recover/facebook', passport.authenticate('facebook-recover'));
  hotplate.app.get('/auth/recover/facebook/callback', function( req, res, next) {
  ...
  hotplate.app.get('/auth/register/facebook', passport.authenticate('facebook-register'));
  hotplate.app.get('/auth/register/facebook/callback', function( req, res, next) {
  ...
  hotplate.app.get('/auth/resume/facebook', passport.authenticate('facebook-resume'));
  hotplate.app.get('/auth/resume/facebook/callback', function( req, res, next) {
