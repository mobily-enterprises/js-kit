          ...
          if( ! res.length ){
            ...
            Users.Get( res[0].userId, function( err, user ){
              if( err ){
                ...
                Users.Put( user.id, user, function( err, newUser ){
                  if( err ){
                    done( err, null );
                  } else {
        ...
        if( err ) {
          ...
          if( res.length ){
              ...
              if( err ){
                ...
                UserStrategies.Post( { userId: user.id, strategyId: 'local', field1: login.toLowerCase(), field3: password }, function( err, res ){
                  if( err ) {
                    done( err, null );
                  } else {
