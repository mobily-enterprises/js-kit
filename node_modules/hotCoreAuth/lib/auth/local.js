...
var exports = module.exports = function( strategyData, makeResponder, AuthStrategies, Users, UserStrategies, UserLogins ) {
  ...
  app.post('/auth/manager/local', function( req, res, next) {
    passport.authenticate('local-manager',  makeResponder( req, res, next, 'local')  )(req, res, next);
  });
  ...
  app.post('/auth/signin/local', function( req, res, next) {
    passport.authenticate('local-signin',  makeResponder( req, res, next, 'local')  )(req, res, next);
  });
  ...
  app.post('/auth/recover/local', function( req, res, next) {
    passport.authenticate('local-recover',  makeResponder( req, res, next, 'local')  )(req, res, next);
  });
  ...
  app.post('/auth/register/local', function( req, res, next) {
    passport.authenticate('local-register',  makeResponder( req, res, next, 'local')  )(req, res, next);
  });
