define([
   ...
   "hotplate/hotDojoWidgets/ConfirmDialog",
    ...
    return declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _Container, _ContentPaneResizeMixin, _OnDijitClickMixin,  _CssStateMixin, _FormValueMixin ] , {
      ...
      postCreate: function(){
        ...
        if( self.value ){
          ...
          when( self.store.query( q, { start: 0, count: 1 }  ) ).then(
        ...
        function connectUp(){
          ...
          self.own( 
            ...
            // FIXME: Is there a generic way of doing this, without relying on global topics?
            // (Note: the store's put() and remove() will need to use aspect() to trigger these)
