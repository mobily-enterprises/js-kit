define([
   ...
   "hotplate/hotDojoWidgets/ConfirmDialog",
    ...
    return declare( _WidgetBase, {
      ...
      // Will need to resize the adding widfet 
      resize: function(){

        // Only resize it if editingWidget KNOWS that it's there to refresh
        if( this.addingWidget && self.addingWidgetPlacement === 'before' ||  self.addingWidgetPlacement === 'after') {
          this.addingWidget.resize();
        }
      ...
      postCreate: function(){
        ...
        // Note: this should be done regardless of its placement. It might
        // end up not being placed, but it needs to exist (in case the developer
        // decides to make it appear later)
        ...
        if( self.addingWidgetPlacement === 'before' ||  self.addingWidgetPlacement === 'after' ){
          if( self.addingWidgetPlacement === 'after' ){
            // Place the widget there
            domConstruct.place( self.addingWidget.domNode, self.domNode, 'last' );
            // put( self.domNode, ">", self.addingWidget.domNode );
            self.addingWidget.startup();
          }
          if( self.addingWidgetPlacement === 'before' ){
            // Place the widget there
            // put( self.domNode, " - ", self.addingWidget.domNode );
            domConstruct.place( self.addingWidget.domNode, self.domNode, 'first' );
            self.addingWidget.startup();
          }
