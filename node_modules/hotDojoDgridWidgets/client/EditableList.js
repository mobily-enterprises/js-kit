  ...
  //r = declare( [ BorderContainer ], {
    ...
    addingConstructorInDialog: function( dialogTitle ){
      ...
      var addingWidget = new self.AddingConstructor({
        ...
        'class': 'adding-form',
        recordId: null,
        parameter: self.addingConstructorParameter
      });
    ...
    postCreate: function(){
      ...
      if( self.EditingConstructor && self.editOnDoubleClick ){
    ...
    _editInDialog: function( row, editingWidget ){
      ...
      if( ! editingWidget ){
        ...
        editingWidget = new self.EditingConstructor({
          ...
          storeParameters: self.storeParameters,
          recordId: row.id,
          paramter: self.editingConstructorParameter
        });
      } 
    ...
    _editInline: function( row ){
      ...
      editingWidget = new self.EditingConstructor({
        ...
        recordId: row.id,
        class: 'editing-form',
        parameter: self.editingConstructorParameter,
      });
