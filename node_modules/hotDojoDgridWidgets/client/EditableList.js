...
, stores
  ...
  r = declare( [_WidgetBase, _TemplatedMixin, _Container, _ContentPaneResizeMixin, _OnDijitClickMixin , _OverlayMixin ], {
    ...
    postCreate: function(){
      ...
      self.listWidget = new self.ListConstructor( { store: self.store } );
      //
      ...
      self.own(
        ...
        // Always set an unclickable overlay when refreshing
        aspect.before( self.listWidget, 'refresh', function( ){    
      ...
      if( self.addingWidgetRegion ){
        ...
        addingWidget.placeAt( self.addingWidgetRegion === 'top' ? self.addingWidgetTopNode : self.addingWidgetBottomNode );
