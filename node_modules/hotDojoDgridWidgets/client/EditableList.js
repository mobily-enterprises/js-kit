...
, _OverlayMixin
  ...
  var DefaultButtonsConstructor = declare( [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _OnDijitClickMixin ], {
    ...
    templateString: ''+
                    '<div>\n'+
                    '  <div class="dijitPopup" data-dojo-type="dijit/form/Button" data-dojo-attach-point="editButtonWidget" data-dojo-props="label:\'Edit\'"> </div>\n'+
  ...
  r = declare( [ BorderContainer, _OverlayMixin ], {
    ...
    postCreate: function(){
      ...
      // TODO: Delete this when dealing with the CSS
      // UPDATE: DELETED
      /*
      self.own(

        aspect.around( self.listWidget, 'renderRow', function( renderRow ){
        PPP = self.listWidget.domNode;
          return function( object, options ){
            var r = renderRow( object, options );
            return r;
          }
    ...
    _editInline: function( row ){
      ...
      //var pos = domStyle.get( row.element, 'position' );
      //if( pos === '' || pos === 'static' ){
      //  domStyle.set( row.element, 'position', 'absolute' );
      //}
