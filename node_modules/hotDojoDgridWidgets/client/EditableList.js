...
, stores
  ...
  r = declare( [_WidgetBase, _TemplatedMixin, _Container, _ContentPaneResizeMixin, _OnDijitClickMixin ], {
    ...
    postCreate: function(){
      ...
      self.listWidget = new L( { store: self.store } );
      //
      ...
      self.own(
        ...
        aspect.before( self.listWidget, 'refresh', function( ){    
            ...
            self.listWidget.set( 'overlayStatus', { overlayed: true, clickable: false } ); // RELOAD ON
        }),
        ...
        on( self.listWidget.domNode, 'dgrid-refresh-complete', function( e ){
          ...
          self.listWidget.set( 'overlayStatus', { overlayed: false, clickable: false } ); // RELOAD OFF
        }),
