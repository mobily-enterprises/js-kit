define([
  ...
  "hotplate/hotDojoWidges/_TemplatedHooksMixin",
    ...
    return declare('hotplate/hotDojoAuth/NewWorkspace', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin ], {
      ...
      postCreate: function(){
        ...
        this.formWidget.onSubmit = ds.defaultSubmit(this.formWidget, this.buttonWidget, function(){
          ...
          stores('workspaces', {} ).noCache.put(data).then(
            ...
            function(res){
              window.location = vars.hotCoreMultiHome.multiHomeURL.replace( ':workspaceId', res._id );
            }
          );
