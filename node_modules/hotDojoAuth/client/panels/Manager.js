...
define([
  ...
  return declare([ _WidgetBase, _Container, _ContentPaneResizeMixin ], {
    ...
    postCreate: function(){
      ...
      resultSet = store.query( {} ); // WAS: resultSet = self.store.query( {} );
      resultSet.then( function( userStrategyDataList ){
        ...
        self.strategyIds.forEach( function( strategyId ){
          ...
          require( [ 'hotplate/hotDojoAuth/auth/' + strategyId ], function( Strategy ){        
            ...
            self.strategyWidgets[ strategyId ] = strategyWidget = new Strategy.Manager( { userStrategyData: userStrategyData, resultSet: resultSet });
