    ...
    postCreate: function(){
      ...
      var F = declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ] , { 
        ...
        templateString: '' +
          ...
          '      <input name="login" id="${id}_login" data-dojo-type="hotplate/hotDojoAuth/ValidationUsername" data-dojo-attach-point="login" data-dojo-props="required: true, ajaxOkWhen:\'present\', ajaxInvalidMessage:\'Login name invalid!\'"></input>\n' +
          ...
          '      <input class="form-submit" type="submit" data-dojo-attach-point="buttonWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton", label="Go"></input>\n' +
          '    </form>\n' +
          '  </div>\n' +
          '</div>\n' +
          '',
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          request.post('/auth/signin/local', { data: data } ).then(
            function( res ){
              ...
              // That's all
              formDialog.hide();
              var successURL = vars['hotDojoAuth']['successURLs']['signin'];
              if( typeof( successURL) === 'undefined' ){
                throw("The Login widget must be used in a hotDojoAuth login form where vars['hotDojoAuth']['successURL'] is set");
              } else {
    ...
    postCreate: function(){
      ...
      var F = declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ] , { 
        ...
        templateString: '' +
          ...
          '    <form data-dojo-type="dijit/form/Form" data-dojo-attach-point="formWidget">\n' +
          '      <label for="${id}_login">Login</label>\n' +
          '      <input name="login" id="${id}_login" data-dojo-type="hotplate/hotDojoAuth/ValidationUsername" data-dojo-attach-point="login" data-dojo-props="required: true, ajaxOkWhen:\'absent\', ajaxInvalidMessage:\'Login name taken!\'"></input>\n' +
          '      <label for="${id}_password">Password</label>\n' +
          '      <input type="password" name="password" id="${id}_password" data-dojo-attach-point="password" data-dojo-type="dijit/form/TextBox" ></input>\n' +
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          request.post('/auth/register/local', { data: data } ).then(
            function( res ){
              ...
              // That's all
              formDialog.hide();
              var successURL = vars['hotDojoAuth']['successURLs']['register'];
  ...
  ret.Resume = declare( [ _ResumeButton ], {
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        var f = new F( { login: self.strategyData.field1 } ) ;
        var formDialog = new TempDialog();
        formDialog.addChild( f );
        formDialog.startup();
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          request.post('/auth/resume/local', { data: data } ).then(
            ...
            function( res ){
              ...
              topic.publish( 'hotDojoAuth/resumed' );
            },
            ...
            function( err ){
              ...
              if( self.attempts > 2 ){
                window.location = vars['hotDojoAppContainer']['failURLs']['signin'];
              } else {
    ...
    postCreate: function(){
      ...
      var F = declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ] , { 
        ...
        templateString: '' +
          ...
          '    <form data-dojo-type="dijit/form/Form" data-dojo-attach-point="formWidget">\n' +
          '      <label for="${id}_login">Login</label>\n' +
          '      <input name="login" id="${id}_login" value="${login}" data-dojo-type="hotplate/hotDojoAuth/ValidationUsername" data-dojo-attach-point="login", data-dojo-props="alwaysOk: \'${login}\', required: true, ajaxOkWhen:\'absent\', ajaxInvalidMessage:\'Login name taken!\'" ></input>\n' +
          '      <label for="${id}_password">Password</label>\n' +
          '      <input type="password" name="password" id="${id}_password" value="${password}" data-dojo-attach-point="password" data-dojo-type="dijit/form/TextBox"></input>\n' +
          '      <input class=form-submit type="submit" data-dojo-attach-point="buttonWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton" label="Go"></input>\n' +
          '    </form>\n' +
          '  </div>\n' +
