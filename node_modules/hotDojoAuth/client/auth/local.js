          ...
          request.post('/auth/signin/local', { data: data } ).then(
            function( res ){
              ...
              if( typeof( successURL) === 'undefined' ){
                throw("The Login widget must be used in a hotDojoAuth login form where vars['hotCoreAuth']['successURL'] is set");
              } else {
  ...
  ret.Manager = declare( [ _ManagerButton ], {
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        if( self.userStrategyData ) cp = { login: self.userStrategyData.field1.toLowerCase(), password: self.userStrategyData.field2 };
        ...
        //f.formWidget.on( 'submit', function( e ){
          ...
          request.post('/auth/manager/local', { data: data } ).then(
            function( res ){
              ...
              self.userStrategyData.field2 = f.formWidget.get('value').password;
              self.userStrategyData._id = res.user[ 'userStrategiesId' ];
