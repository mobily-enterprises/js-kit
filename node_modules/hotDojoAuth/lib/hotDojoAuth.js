...
hotplate.hotEvents.on( 'setRoutes', hotplate.cachable( function( app, done ){
   ...
   // Pages
  app.get(  path.join( hotplate.config.get( 'hotplate.dynamicUrlPrefix' ), '/auth/welcome' ) , pageWelcome);
  app.get(  path.join( hotplate.config.get( 'hotplate.dynamicUrlPrefix' ), '/auth/pick' ) , pagePick );
