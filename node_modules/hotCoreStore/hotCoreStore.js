...
// Simple schema
exports.BasicSchema =  declare( [ SimpleSchema, hotplate.config.get( 'hotplate.SchemaMixin') ] );

// Enhanced schema (legacy)
exports.HotSchema = BasicSchema;
...
exports.BasicDbStore = declare( [ JsonRestStores, JsonRestStores.SimpleDbLayerMixin, JsonRestStores.HTTPMixin ], {
  DbLayer: DbLayer,
});

// Creates a basic DB store based on that layer
exports.HotStore = declare( [ exports.BasicDbStore ], { enableComet: true } );

/* Legacy function, that's how stores worked before */
