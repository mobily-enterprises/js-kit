...
/**
 * HotCoreClientFiles constructor.
 *
 * The exports object of the `HotCoreClientFiles` module is an instance of this class.
 * Most apps will only use this one instance.
 *
 * @api public
 */

function HotCoreClientFiles() {
  this.localLocations = {};
};


/**
 * The exports object is an instance of HotCoreClientFiles.
 *
 * @api public
 */

module.exports = exports = new HotCoreClientFiles;
var hotCoreClientFiles = module.exports;


/**
 * The HotCoreClientFiles constructor
 *
 *
 * ####Example:
 *
...
hotCoreClientFiles.HotCoreClientFiles = HotCoreClientFiles;

HotCoreClientFiles.prototype.hotHooks = {};


HotCoreClientFiles.prototype.hotHooks.init = function( done ){
...
HotCoreClientFiles.prototype.hotHooks.init.invokes = [ 'clientPaths' ];


HotCoreClientFiles.prototype.add = function(moduleName, localLocation){
  this.localLocations[ moduleName ] = localLocation
}

HotCoreClientFiles.prototype.serve = function(options){
  var that = this;
