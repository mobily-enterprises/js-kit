...
hotplate.config.set('hotCoreClientFiles.renderExtensions',  { '.jadee': true } );
...
/**
  ...
  @event init
*/
var getLocalLocations = exports.getLocalLocations = hotplate.cachable( function( done ){

  var moduleName;
  var localLocations = {};

  hotplate.hotEvents.emit( 'clientPaths', function( err, results ){
...
var getRenderList = exports.getRenderList = hotplate.cachable( function( done ){

  var moduleName;
  var renderList = {};

  hotplate.hotEvents.emit( 'clientPathsRender', function( err, results ){
    results.forEach( function( element ) {
      moduleName = element.module;
