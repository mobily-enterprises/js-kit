...
hooks.pageElements = function( done ){
  ...
  if( typeof( conf.dojoUrl ) === 'undefined' ){
    // conf.dojoUrl = "//ajax.googleapis.com/ajax/libs/dojo/1.8.3/dojo/dojo.js";
    conf.dojoUrl = "//ajax.googleapis.com/ajax/libs/dojo/1.8.3/dojo/dojo.js.uncompressed.js";
  }
  ...
  hotplate.hotEvents.emit( 'enrichDojoConf', conf, function( err, results ){
