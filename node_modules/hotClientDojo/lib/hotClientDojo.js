...
hotplate.hotEvents.on( 'pageElementsPerPage', 'hotClientDojo', function( req, pageName, done ){
  ...
  requireLine += '  require(["dojo/topic", "dojo/dom-class", "dojo/_base/window", "hotplate/hotClientDojo/comet/messages", "hotplate/hotClientDojo/globalAlertBar/mainAlertBar", "hotplate/hotClientDojo/stores/AppStoreNotify", ';
...
hotplate.hotEvents.on( 'dojoModulesPerPage', 'someModule', function( req, pageName, done ){
