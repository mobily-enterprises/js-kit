  ...
  function updateParentsCache( type, storeName, o ){
    ...
    parentStores.forEach( function( parentStoreEntry ){
      ...
      for( var k in definedStores ){
        ...
        // NOTE: this is 'return', so that it will go to the next parentStoreEntry.
        // If the first store doesn't have memCache, the others won't do either
        if( ! store.memCache ) return;
          ...
          case 'multiple':
            ...
            for( var i = 0, l = data.length; i < l; i ++ ){
              ...
              if( type === 'create'){
                ...
                store.emit( 'update', { event: { target: record } } );
