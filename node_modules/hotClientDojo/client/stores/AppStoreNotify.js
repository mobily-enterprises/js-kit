...
/*
  ...
  // NOTE: Commented out on 9/4/2015. There is no point in resetting the stores here,
  // as this is already happening in stores.js (where it makes more sense to happen)
  ...
  topic.subscribe( 'resetStores', function(){
    ...
    for( var storeName in allDefinedStores ){
      ...
      for( var target in definedStores ){
        ...
        console.log('STORE:', storeName, store.preserveCacheOnReset );
        if( ! configStores[ store.storeName ] && ! store.preserveCacheOnReset ){
