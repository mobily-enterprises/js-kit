  ...
  var SignInRecoverRegisterBase = declare( [ _SignInRecoverRegisterButton ], {
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        window.open( urlPrefix + '/auth/' + self.action + '/facebook', '', 'width=800, height=600');
      });
    },
  });
  ...
  ret.Resume = declare( [ _ResumeButton ], {
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        window.open( urlPrefix + '/auth/resume/facebook', '', 'width=800, height=600');
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        if( ! self.userStrategyData ){
          ...
          window.open( urlPrefix + '/auth/manager/facebook', '', 'width=800, height=600');
        } else {
