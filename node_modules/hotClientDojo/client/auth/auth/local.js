...
, _ResumeButton
  ...
  var ret = {};
  var urlPrefix = vars['hotCorePage']['routeUrlPrefix'];
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          request.post( urlPrefix + '/auth/signin/local', { data: data } ).then(
            function( res ){
              try {
                res = JSON.parse( res );
              } catch( e ) {};
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          var data = f.formWidget.get('value');
          data.password = 'dummy';
          request.post( urlPrefix + '/auth/recover/local', { data: data } ).then(
            function( res ){
              try {
                res = JSON.parse( res );
              } catch( e ) {};
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          var data = f.formWidget.get('value');
          //data.responseType = 'ajax';
          request.post( urlPrefix + '/auth/register/local', { data: data } ).then(
            function( res ){
              try {
                res = JSON.parse( res );
              } catch( e ) {};
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        f.formWidget.on( 'submit', ds.defaultSubmit( f.formWidget, f.buttonWidget, function(){
          ...
          request.post( urlPrefix + '/auth/resume/local', { data: data } ).then(
    ...
    postCreate: function(){
      ...
      self.button.on('click', function( e ){
        ...
        //f.formWidget.on( 'submit', function( e ){
          ...
          //data.responseType = 'ajax';
          request.post( urlPrefix + '/auth/manager/local', { data: data } ).then(
            function( res ){
              try {
                res = JSON.parse( res );
              } catch( e ) {};
