...
, _OverlayMixin
  ...
  return declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin, Destroyable ] , {
    ...
    postCreate: function(){
      ...
      if( self.recordId ) {
        var idTextBox = new TextBox( { type:"hidden", name: self.store.idProperty, value: self.recordId } );
        idTextBox.placeAt( this.formWidget.containerNode, 'first' );

        if( self.storeName === 'WorkspacesInfo' )  console.log("SETTING: "  + self.recordId );
      }
      ...
      this.formWidget.onSubmit = ds.defaultSubmit(this.formWidget, this.buttonWidget, function(){
        ...
        if( self.storeName === 'WorkspacesInfo' )  console.log("FORM VALUES: " , formValues );
    ...
    loadInfo: function(){
      ...
      //console.log("loadInfo called for" , self.storeName );
