    ...
    postCreate: function(){
      ...
      self.own(
        ...
        topic.subscribe('storeRecordUpdate', function( from, message, remote ){
          ...
          // and if suppressEditingReload is false, then place an overlay on the record
          if( remote ){
            if( message.storeName === self.storeName && message.objectId == self.recordId && !message.suppressEditingReload  && ! message.justReposition ){
