...
hotplate.hotEvents.on( 'stores', 'hotCoreComet', hotplate.cachable( function( done ){
  ...
  stores.TabMessages = declare( BasicDbStore, {
    ...
    // COMMON
    schema: new BasicDbSchema({
      messageId:     { type: 'id', required: true },
      tabId:         { type: 'id', required: true },
...
/*
      setInterval( function(){
        ...
        storesData.stores.tabs.storeObject.dbLayer.delete( { conditions: { and: [ { field: 'lastSync', type: 'lte', value: new Date() - TABLIFESPAN } ] } }, { multi: true }, function(){
          //TODO: Log error
          //storesData.stores.tabMessages.Store.MassDelete( { filters: { toAdded: new Date() - TABLIFESPAN } }, function ( err ){
          storesData.stores.tabMessages.storeObject.dbLayer.delete( { conditions: { and: [ { field: 'added', type: 'lte', value: new Date() - TABLIFESPAN } ] } }, { multi: true }, function(){
            // TODO: Log error
            cleaningUp = false;
          });
        });
