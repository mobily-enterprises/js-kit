				...
				if(listeners.push(listener) == 1){
                    ...
                    // of the resultsArray
								    	...
								    	var pos = resultsArray.length;
											...
											tellAllListeners( changed, ownPosition, pos );
										} else {
								...
								if( ownPosition == -1 ){
									...
									// made and therefore observed yet)
									} else if( options.placeNew === 'last' || options.placeNew === undefined || methodOptions.before === null ){
										...
										when( results.total ).then( function( grandTotal ) {
											...
											if( (options.start == 0 && options.count == 0 ) || newQueryTotal >= grandTotal || methodOptions.before === null ){
												var pos = resultsArray.length;
												resultsArray.push( changed );
...
*/
	...
	whenFinished("put", function(object, methodOptions ){
		console.log("METHOD OPTIONS HERE:", methodOptions );
