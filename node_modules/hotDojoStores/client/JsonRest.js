...
return declare("dojo.store.JsonRest", base, {
    ...
    console.log("OPTIONS IN JSONREST:", options );
    if( options ){
    	if( options.before ){
        console.log("OPTIONS BEFORE IS:", this.getIdentity( options.before) );
        options.headers[ 'X-hotplate-before' ] = this.getIdentity( options.before);
      }

      if( options && options.relocation ){
        console.log("OPTIONS RELOCATION IS:", options.relocation );
        options.headers[ 'X-hotplate-relocation' ] = true;
      }
    }
