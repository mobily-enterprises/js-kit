define(["dojo/_base/declare", "dojo/store/util/QueryResults", "dojo/store/util/SimpleQueryEngine" /*=====, "./api/Store" =====*/],
...
return declare("dojo.store.Memory", base, {
	...
	put: function(object, options){
		...
		if(id in index){
			...
			// replace the entry in data, unless it's simply a reposition
			// (in which case the data should not be overwritten as the object
			// could potentially be incomplete)
                        
			if( ! (options && options.justReposition ) ){
		...
		// Take into account options.before, as described in dojo documentation

		// If options.before is set, and there is an element in that spot in the array...
		if( typeof(options) === 'object' && options !== null && typeof(options.before) !== 'undefined' ){
