    ...
    aspect.around( store, 'put', function( put ){
      ...
      return function( object, options ){
        ...
        return when( put.call( store, object, options ) ).then( function( r ) {
          ...
          topic.publish(eventName, null, { storeName: storeName, storeTarget: store.target, objectId: r[identity], object: object, remote: false }  );
    ...
    aspect.around( store, 'add', function( add ){
      return function( object, options ){
        ...
        return when( add.call( store, object, options ) ).then( function( r ) {
          ...
          topic.publish('storeCreate', null, { storeName: storeName, storeTarget: storeTarget, objectId: r[identity], object: object, remote: false }  );
    ...
    aspect.around( store, 'remove', function( remove ){
      return function( objectId, options ){
        ...
        return when( remove.call( store, objectId, options ) ).then( function( r) {
          ...
          topic.publish('storeRemove', null, { storeName: storeName, storeTarget: store.target, objectId: objectId, remote: false }  );
