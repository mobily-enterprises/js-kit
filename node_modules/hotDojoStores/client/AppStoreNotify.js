    ...
    aspect.around( store, 'add', function( add ){
      return function( object, options ){
        ...
        return when( add.call( store, object, options ) ).then( function( r ) {
          ...
          topic.publish('storeCreate', null, { storeName: storeName, object: object, remote: false }  );
    ...
    if( message.remote ){
      ...
      if( store ){
        ...
        topic.publish('storeUpdate/afterCache', from, message);
         ...
         // throw( new Error("Received a Comet message for an unknown store: " + message.storeName ) );
      }
