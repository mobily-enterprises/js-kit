...
define([
    ...
    aspect.around( store, 'add', function( add ){
      return function( object, options ){
        ...
        return when( add.call( store, object, options ) ).then( function( r ) {
          ...
          topic.publish('storeCreate', null, { storeName: storeName, storeTarget: storeTarget, objectId: r[identity], object: object }, false }  );
    ...
    aspect.around( store, 'remove', function( remove ){
      return function( objectId, options ){
        ...
        return when( remove.call( store, objectId, options ) ).then( function( r) {
          ...
          topic.publish('storeRemove', null, { storeName: storeName, storeTarget: store.target, objectId: objectId }, false );
  ...
  topic.subscribe('storeUpdate', function( from, message, remote ){
  ...
  topic.subscribe('storeCreate', function( from, message, remote ){
    // A Comet changed a remote store. Refresh the Something came from a Comet. 
    if( remote ){
  ...
  topic.subscribe('storeRemove', function( from, message, remote ){
    // A Comet changed a remote store. Refresh the Something came from a Comet. 
    if( remote ){
