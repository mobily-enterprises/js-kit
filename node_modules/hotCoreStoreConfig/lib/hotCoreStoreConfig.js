...
var getConfigRecords = exports.getConfigRecords = function( workspaceId, userId, cb ){
  ...
  if( typeof( hotplate.get('hotCoreMultiHome') ) === 'undefined' || ! hotplate.get('hotCoreMultiHome').enabled ){
    delete workspaceId;
  }
...
hotplate.hotEvents.on( 'pageElements', 'hotCoreStoreConfig', function( done ){
...
exports.getConfigStores = getConfigStores = function( done ){
