...
hooks.init = function( done ){
  ...
  exports.StoreMixin = declare(null, {
    ...
    _broadcast: function( type, objectId, object ){

      var makeTabIdHash;
      var fromUserId;

      // No comet required
      if( this.killComet ) return;
      ...
      hotplate.invokeAll('cometBroadcast', this._req.session.userId, this._getTabId(), makeTabIdHash, { type: type, storeName: this.storeName, objectId: objectId, object: object } );
    ...
    afterPutExisting: function( params, body, options, doc, fullDoc, docAfter, fullDocAfter, overwrite, done ){
      ...
      this._broadcast( 'storeRecordUpdate', docAfter[ this.idProperty], docAfter );
    ...
    afterPost: function( params, body, options, doc, fullDoc, done ){
      ...
      this._broadcast( 'storeRecordInsert', doc[ this.idProperty], doc );
    ...
    afterDelete: function( params, body, options, doc, fullDoc ){
      ...
      this._broadcast( 'storeRecordRemove', doc[ this.idProperty ], doc ); 
