    ...
    if( err ){
      ...
      classes.HotStoreMixin = declare( null, {
        ...
        broadcastStoreChanges: function( request, type, objectId, object, options, cb ){
          ...
          defaultNewToStart = !! options.defaultNewToStart;
          ...
          message = { type: type, storeName: this.storeName, objectId: objectId, object: object, justReposition: justReposition, suppressReload: suppressReload };

          if( typeof( options.beforeId ) !== 'undefined' ){
            message.beforeId = options.beforeId;
          }
