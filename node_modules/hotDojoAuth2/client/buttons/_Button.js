...
define([
  ...
  return declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {
    ...
    templateString: '<div><div class="login-button" data-dojo-type="dijit/form/Button" data-dojo-attach-point="button" data-dojo-props="iconClass: \'login-button-${strategyId}\'"></div></div>',
