    ...
    postCreate: function(){
      ...
      resultSet.then( function( strategyDataList ){
        ...
        self.strategyIds.forEach( function( strategyId ){
          ...
          require( [ 'hotplate/hotDojoAuth2/auth/' + strategyId ], function( Strategy ){        

            var strategyData = strategyDataList.filter( function( o ) { return o.strategyId == strategyId } )[0];
            var strategyWidget;
  
            self.strategyWidgets[ strategyId ] = strategyWidget = new Strategy.Manager( { store: self.store, strategyData: strategyData, resultSet: resultSet });
