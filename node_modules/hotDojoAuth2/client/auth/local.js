    ...
    postCreate: function(){
      ...
      var F = declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ] , { 
        ...
        templateString: jade.compile( '' +
          ...
          '      input( name="login", id="${id}_login", data-dojo-type="hotplate/hotDojoAuth2/ValidationUsername", data-dojo-attach-point="login", data-dojo-props="required: true, ajaxOkWhen:\'present\', ajaxInvalidMessage:\'Login name invalid!\'")\n' +
          '      label( for="${id}_password") Password\n' +
          '      input( type="password", name="password", id="${id}_password", data-dojo-attach-point="password", data-dojo-type="dijit/form/TextBox" )\n' +
    ...
    postCreate: function(){
      ...
      var F = declare( [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ] , { 
        ...
        templateString: jade.compile( '' +
          ...
          '    form( data-dojo-type="dijit/form/Form", data-dojo-attach-point="formWidget")\n' +
          '      label( for="${id}_login") Login\n' +
          '      input( name="login", id="${id}_login", value="${login}", data-dojo-type="hotplate/hotDojoAuth2/ValidationUsername", data-dojo-attach-point="login", data-dojo-props="alwaysOk: \'${login}\', required: true, ajaxOkWhen:\'absent\', ajaxInvalidMessage:\'Login name taken!\'")\n' +
          '      label( for="${id}_password") Password\n' +
          '      input( type="password", name="password", id="${id}_password", value="${password}", data-dojo-attach-point="password", data-dojo-type="dijit/form/TextBox" )\n' +
          '      input.form-submit(type="submit",data-dojo-attach-point="buttonWidget", data-dojo-type="hotplate/hotDojoWidgets/BusyButton", label="Go")\n' +
