...
/*
  TODAY:
  Server side part, if workspace created, user added automatically (using hooks)
...
hooks.run = function( done ){
  ...
  var declareStore = hotplate.getModule( 'hotCoreJsonRestStores' ).declareStore;
  ...
  var Workspaces = declareStore( Store, {
  ...
  var WorkspaceInvites = declareStore( Store, {
  ...
  // The basic schema for the WorkspaceUsers table
  var WorkspacesUsersBase = declareStore( Store, {
  ...
  var WorkspaceUsers = declareStore( WorkspacesUsersBase, {
    handlePut: false,
    handlePost: true,
    handleGet: false,
    handleGetQuery: true,
  ...
  var UserWorkspaces = declareStore( WorkspacesUsersBase, {
...
hooks.stores = function( done ){
    ...
    userWorkspaces     : { target: '/users/:userId/workspaces/',        idProperty: '_id', sortParam: 'sortBy', },
