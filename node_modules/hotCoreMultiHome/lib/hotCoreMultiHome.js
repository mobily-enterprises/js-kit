      ...
      allStores.tabs.apiGetQuery( { }, function( err, tabs ){
        if( err ){
          ...
          // to that specific workspaceId
            ...
            allStores.workspacesUsersBase.apiGetQuery( { conditions: { workspaceId: message.target.workspaceId } }, function( err, workspacesUsers ){
          ...
          // who are in the same workspace as userId
            ...
            allStores.workspacesUsersBase.apiGetQuery( { conditions: { userId: userId } }, function( err, workspacesUsers ){
              ...
              workspacesUsers.forEach( function( w ){
                ...
                // Get a list of users for that workspace
                allStores.workspacesUsersBase.apiGetQuery( { conditions: { workspaceId: w.workspaceId } }, function( err, workspacesUsers ){
...
var userInWorkspace = exports.userInWorkspace = function( userId, workspaceId, done ){
  ...
  stores.workspacesUsersBase.apiGetQuery( { conditions: { userId: userId, workspaceId: workspaceId } }, function( err, docs ){
    if( err ){
      done( err );
    } else {
