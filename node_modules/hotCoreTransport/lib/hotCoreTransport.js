  ...
  hotCoreStoreRegistry.getAllStores( function( err, storeRegistry){
    ...
    setInterval( function(){
      ...
      stores.messagesTo.dbLayer.select(
        { conditions: { name: 'and', args: [ 
          { name: 'lt', args: [ 'attemptAfter', now ] },
          { name: 'eq', args: [ 'status', 'todeliver' ] },
        ] } }, 
...
var logLine = exports.transportLayerFunctions.logLine = function( config, messageId, messageToId, logLevel, line, errInLogline ){
  ...
  hotplate.hotEvents.emit('augmentMessageDeliveryLog', o, function( err ){
    ...
    stores.messagesDeliveryLog.dbLayer.insert(o, { returnRecord: true }, function( err, oRecord ){
...
exports.transportLayerFunctions.changeMessageStatus = function( transport, config, messageTo, failedAttempt, newMessageStatus, done ){
  ...
  stores.messagesTo.dbLayer.update( { name: 'eq', args: [ 'id', messageTo.id ] }, { status: messageTo.status, failedAttempts: messageTo.failedAttempts }, function( err ){
...
exports.transportLayerFunctions.deleteUnfinishedMessage = function( config, messageId ){
  ...
  stores.messagesTo.dbLayer.delete( { name: 'eq', args: [ 'messageId', messageId ] }, { multi: true }, function( err ){
    if( err ){
    ...
    stores.messagesAttachments.dbLayer.delete( { name: 'eq', args: [ 'messageId', messageId ] }, { multi: true }, function( err ){
      if( err ){
      ...
      stores.messages.dbLayer.delete( { name: 'eq', args: [ 'id', messageId  ] }, { multi: true }, function( err ){
        if( err ){
