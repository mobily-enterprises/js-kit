...
function mainApp( req, res, next ){
  ...
  extraVars.add( 'hotDojoAppContainer', { name: 'failURLs', value: hotplate.config.get('hotCoreAuth.redirectURLs.fail') } );
  extraBodyLines.add( 'hotDojoAppContainer', '<div id="appContainer"></div>' );
