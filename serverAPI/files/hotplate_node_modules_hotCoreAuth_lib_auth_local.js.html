...
<div id="doc">
    ...
    <div id="hd" class="yui3-g header">
        <div class="yui3-u-3-4">
            <h1><a href="../index.html">Hotplate&#x27;s API: hotplate/node_modules/hotCoreAuth/lib/auth/local.js</a></h1>
            <!--<h1><a href="../index.html"><img src="../assets/css/logo.png" width="117" height="52">Hotplate&#x27;s API: hotplate/node_modules/hotCoreAuth/lib/auth/local.js</a></h1> -->
        </div>
    ...
    <div class="yui3-g">
        ...
        <div id="main" class="yui3-u">
            <div class="content"><h4>hotplate/node_modules/hotCoreAuth/lib/auth/local.js</h4>
...
exports.strategyRoutesMaker = function( app, strategyName, done  ){
  ...
  hotCoreStoreRegistry.getAllStores( function( err, stores ){
    ...
    app.post( prefix( &#x27;/auth/manager/local&#x27; ), function( req, res, next) {
    ...
    app.post( prefix( &#x27;/auth/signin/local&#x27; ), function( req, res, next) {
    ...
    app.post( prefix( &#x27;/auth/recover/local&#x27; ), function( req, res, next) {
    ...
    app.post( prefix( &#x27;/auth/register/local&#x27; ), function( req, res, next) {
    ...
    app.post( prefix( &#x27;/auth/resume/local&#x27; ), function( req, res, next) {
