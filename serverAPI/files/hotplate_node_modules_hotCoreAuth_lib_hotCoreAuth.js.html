...
hotCoreOut can be configured. Here is its basic confguration:
...
* &#x60;closeResponsePage&#x60;. The function that will generate the page responsible of closing the current window
in case the response type is &#x60;close&#x60;. Note that a basic &#x60;basicCloseResponsePage&#x60; function is set as default and can be used as
a template.

* &#x60;redirectOpenerResponsePage&#x60;. The function that will generate the page responsible of redirecting the
opener to the appropriate URL. Note that a basic &#x60;BasicRedirectOpenerResponsePage&#x60; function is set as default and can be used as
a template
