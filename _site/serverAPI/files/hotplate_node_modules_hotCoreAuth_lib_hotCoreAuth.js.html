...
The list of userss. Note that only very little information is stored about the user itself: this table only stores the &#x60;id&#x60; and the &#x60;recoverTonen&#x60; fields. 
...
The list of strategies associated to a specific user.
...
The strategies available. This store is a pseudo-store (it doesn&#x27;t rely on data stored in a database).
...
This is used so that an applicaton can know in advance if a user login is already taken. It does so by querying &#x60;usersStrategies&#x60; 
  ...
  hotCoreStoreRegistry.getAllStores( function( err, stores ){
    ...
    if( typeof( hotplate.config.get(&#x27;hotCoreAuth.strategies&#x27; )) === &#x27;object&#x27; ){
      Object.keys( hotplate.config.get(&#x27;hotCoreAuth.strategies&#x27; )).forEach( function( strategyName ) {
        ...
        //strategyMaker( app, strategyConfig, stores.authStrategies, stores.users, stores.usersStrategies, stores.logins );
        strategyMaker( app, strategyName, stores );
