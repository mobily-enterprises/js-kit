...
* Creating authentication routes to handle authentication

# The basics

Authentication is based on Passport, and it&#x27;s the most complex part of Hotplate.
There are five operations connected to authentication:
...
There are currently two implemented strategies:

* local -- using simply a combination of login and password
* facebook -- using Facebook&#x27;s authentication scheme

In hotCoreAuth, the action that is about to be performed is defined by the pair _strategy-operation_. For example, &#x60;local-signin&#x60;, or &#x60;facebook-recover&#x60;, etc.
...
## The nitty-gritty of passport in &#x60;hotCoreAuth&#x60;

Understanding exactly what happens with passport is crucial to fully understand hotCoreAuth. I will explain here how the &#x60;facebook-signin&#x60; operation happens, step by step.
...
You will need to get those values from Facebook, a they are unique to you (you will actually need to logon to Facebook to obtain them).
...
* Run the function _returned by &#x60;makeResponder()&#x60;_, passing it &#x60;err, user, profile&#x60;. Here where &#x60;err&#x60; and &#x60;profile&#x60; are the same values returned by the custom authentication function.
