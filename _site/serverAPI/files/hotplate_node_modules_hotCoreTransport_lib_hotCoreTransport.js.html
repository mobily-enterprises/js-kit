                    ...
                    <div class="content">
                        ...
                        */
                        ...
                        hotplate.config.set(&#x27;hotCoreTransport&#x27;, {
                          ...
                          activeTransports: {
                            ...
                            &#x27;sms-plivo&#x27;: {
                              signatureHost: null,
                              updateUrl: &#x27;http://27.33.233.17:3000/app/incomingsms/plivo-update&#x27;,
                        ...
                        hotplate.hotEvents.on( &#x27;stores&#x27;,&#x27;hotCoreTransport&#x27;, hotplate.cachable( function( done ){
                          hotCoreJsonRestStores.get( function( err, s ){
                            ...
                            var Messages = declare( [ BasicDbStore ],  {
                              ...
                              prepareBody: function( request, method, p, done ){
                        
                                // Only makes sense on &quot;writing&quot; methods
                                if( method !== &#x27;post&#x27; &amp;&amp; method !== &#x27;put&#x27;) return done( null, request.body );
                        
                                // Sets bodyHtmlSane, the sanitised version of the HTML (usable by web clients)
                                request.body.bodyHtmlSane = sanitize( request.body.bodyHtml );
                        ...
                        console.log( &quot;CHECK&quot;, hotplate.hotEvents.listenersByModuleEvent.hotCoreTransport );
                        ...
                        function startTransportCron(){
                          ...
                          hotCoreStoreRegistry.getAllStores( function( err, storeRegistry){
                            ...
                            setInterval( function(){
                              ...
                              var now = new Date();
                              stores.messagesTo.dbLayer.select( {conditions: { and: [ { field: &#x27;attemptAfter&#x27;, &#x27;type&#x27;: &#x27;lt&#x27;, value: now }, { field: &#x27;status&#x27;, type: &#x27;is&#x27;, value: &#x27;todeliver&#x27; } ]  } }, { useCursor: true , delete: false, children: true }, function( err, cursor, total, grandTotal ){
                                  ...
                                  function( callback ){
                                    ...
                                    cursor.next( function( err, messageTo ){
                                      ...
                                      getTransportConfig( messageTo, function( err, transportConfig ){
                                        ...
                                        hotplate.hotEvents.emit( &#x27;transportManipulateBeforeSend&#x27;, transportConfig.transport, messageTo, transportConfig.config, function( err ){
                        ...
                        */
                        ...
                        var logLine = exports.transportLayerFunctions.logLine = function( config, messageId, messageToId, logLevel, line, errInLogline ){
                          ...
                          hotplate.hotEvents.emit(&#x27;augmentMessageDeliveryLog&#x27;, o, function( err ){
                            if( err ){
                            ...
                            stores.messagesDeliveryLog.apiPost(o, function( err, oRecord ){
                              ...
                              hotplate.hotEvents.emit( &#x27;transportLog&#x27;, oRecord, function( err, results ) { 
                        ...
                        exports.transportLayerFunctions.changeMessageStatus = function( transport, config, messageTo, failedAttempt, newMessageStatus, done ){
                          ...
                          stores.messagesTo.dbLayer.update( { conditions: { and: [ { field: &#x27;id&#x27;, type: &#x27;is&#x27;, value: messageTo.id  } ] } }, { status: messageTo.status, failedAttempts: messageTo.failedAttempts }, function( err ){
                            ...
                            hotplate.hotEvents.emit( &#x27;changeMessageStatus&#x27;, transport, config, messageTo, function( err ) {
                              if( err ){
                        ...
                        exports.transportLayerFunctions.deleteUnfinishedMessage = function( config, messageId ){
                          ...
                          stores.messagesTo.dbLayer.delete( { conditions: { and: [ { field: &#x27;messageId&#x27;, type: &#x27;is&#x27;, value: messageId  } ] } }, { multi: true }, function( err ){
                            if( err ){
                              if( config ) logger.log( { error: err, system: true, logLevel: 3, message: &quot;Error while deleting elements from messagesTo for incomplete message&quot;, data: { config: config, messageId: messageId } } );
                            }
                        
                            stores.messagesAttachments.dbLayer.delete( { conditions: { and: [ { field: &#x27;messageId&#x27;, type: &#x27;is&#x27;, value: messageId  } ] } }, { multi: true }, function( err ){
                              if( err ){
                                if( config ) logger.log( { error: err, system: true, logLevel: 3, message: &quot;Error while deleting elements from messagesAttachments for incomplete message&quot;, data: { config: config, messageId: messageId } } );
                              }
                        
                              stores.messages.dbLayer.delete( { conditions: { and: [ { field: &#x27;id&#x27;, type: &#x27;is&#x27;, value: messageId  } ] } }, { multi: true }, function( err ){
                                if( err ){
                                  if( config ) logger.log( { error: err, system: true, logLevel: 3, message: &quot;Error while deleting elements from messages for incomplete message&quot;, data: { config: config, messageId: messageId } } );
                                }
