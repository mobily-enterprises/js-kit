...
exports.hotHooks.init = function( done ){
  ...
  hotplate.invokeAll('pageElements', function(err, results){
    ...
    exports.pageTemplate = replacePageElements( exports.pageTemplate, { 
...
exports.hotHooks.init.invokes = [ 'pageElements' ];
...
exports.processPageTemplate = function( elements, req, pageName, done ) {
  ...
  hotplate.invokeAll('pageElementsPerPage', elements, req, pageName, function( err, results ){
    if( err ){
      ...
      enrichElementsWithHookResults( elements, results )
      r = replacePageElements( exports.pageTemplate, elements );
