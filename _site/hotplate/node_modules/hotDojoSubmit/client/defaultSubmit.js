        ...
        switch(err.status){
          ...
          case 401:
            ...
            if(! noLogin){
              ...
              topic.publish( 'hotDojoSubmit/unauthorized' );
            }
          ...
          case 403:
            ...
            topic.publish('hotDojoSubmit/forbidden');
          ...
          default:
            ...
            var statusString = typeof(err.status) === 'undefined' || err.status == 0 ? '' : ' Status: ' + err.status;
