...
exports.hotCoreErrorHandler = function( err, req, res, next){
  ...
  var sendResponse = require('hotCoreProtocol').sendResponse;
  ...
  // Work out workspaceId from the request headers or the request's parameters
  var workspaceId = request._req.headers[ 'x-hotplate-workspaceid' ] || res.params.workspaceId;
  if( workspaceId ) l.workspaceId = workspaceId;

  // Work out userId from the session if available
  ...
  console.log( "********************" );
  console.log( "********************" );
  console.log( "********************Server is about to log: : %l", l );
  console.log( "********************" );
  console.log( "********************" );
  console.log( "********************" );
  console.log( "********************" );
  ...
  // The way the error is relayed back to the user depends on their abilities
