...
hotplate.hotEvents.on( 'stores', 'hotCoreComet', function( done ){
  ...
  // Get the DB classes
  var PermStore = declare( [ Store, MongoDriverMixin ],   { db: hotplate.config.get('hotplate.db') } );
  var PermSchema = declare( [ Schema, MongoSchemaMixin ], { db: hotplate.config.get('hotplate.db') } );
