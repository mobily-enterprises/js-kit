...
MongoStore.prototype.checkPermissionsPost = function( req, next, cb ){
  cb();
}
...
MongoStore.prototype.makePut = function(  ){
      ...
      if( errors.length ){
        ...
        self.checkPermissionsPost( req, next, function(){
                ...
                self.setPostObject( req, next, cleanBody, function(){
                  ...
                  this.collectionObject.update( self.findAndModify( req, next, function( err, doc ) {
...
MongoStore.prototype.makePost = function(  ){
