...
exports.mongoSchema = null;
exports.logObject = null;
...
exports.calculateSchema = function(){
...
exports.hooks.log = function(entry){

  console.log("Mongologged called (log hook): %j ", entry );
