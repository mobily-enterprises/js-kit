...
hooks.run = function( done ){
  ...
  var HotStore = declare( MongoStore, {
  ...
  Store.makeAll( app, '/call/:workspaceIdCall/userConfig/', ':userId', UserConfig );
  ...
  Store.makeAll( app, '/call/userConfigNoWorkspace/', ':userId', UserConfigNoWorkspace );
  ...
  Store.makeAll( app, '/call/:workspaceIdCall/workspaceConfig/', ':workspaceId', WorkspaceConfig );
  ...
  var AccessConfig = declare( HotStore, {
    ...
    allDbFetch: function( req, cb ){
      this.collection.findOne( { _id: req.application.workspace._id , 'access._id': ObjectId( req.params.userId) }, cb );
    },
  ...
  Store.makeAll( app, '/call/:workspaceIdCall/accessConfig/', ':userId', AccessConfig );
