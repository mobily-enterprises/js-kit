...
hooks.run = function( done ){
  ...
  var userConfig = new resUtils.Config( {
    ...
    schema: new resUtils.SimpleSchema({
      ...
      lastName: { type: 'string', notEmpty: true, trim: 50 },
  ...
  app.get( '/call/:workspaceIdCall/userConfig/:userId', resUtils.makeGet( userConfig ) );
  app.put( '/call/:workspaceIdCall/userConfig/:userId', resUtils.makePut( userConfig ) );
  ...
  app.get( '/call/userConfigNoWorkspace/:userId', resUtils.makeGet( userConfigNoWorkspace ) );
  app.put( '/call/userConfigNoWorkspace/:userId', resUtils.makePut( userConfigNoWorkspace ) );



  var workspaceConfig = new resUtils.Config( {
  ...
  app.get( '/call/:workspaceIdCall/workspaceConfig/:workspaceId', resUtils.makeGet( workspaceConfig) );
  app.put( '/call/:workspaceIdCall/workspaceConfig/:workspaceId', resUtils.makePut( workspaceConfig) );



  var accessConfig = new resUtils.Config( {
  ...
  app.get( '/call/:workspaceIdCall/accessConfig/:userId', resUtils.makeGet( accessConfig ) );
  app.put( '/call/:workspaceIdCall/accessConfig/:userId', resUtils.makePut( accessConfig ) );
