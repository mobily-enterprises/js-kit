...
hooks.run = function( done ){
  ...
  var declare = JsonRestStores.declare;
  var e = hotplate.getModule('hotMongoStores').Errors;

  JsonRestStores.SimpleSchema.checkId = JsonRestStores.MongoStore.checkId;

  var OptionsStore = declare( JsonRestStores.MongoStore,  {
    storeName: 'options',
    ...
    handleGet: true,
    handlePut: true,
    checkPermissionsGet: function( req, doc, originalDoc, cb ){
      if( req.params.optionId == '44' ){
        cb( null, false );
      } else {
        cb( null, true );
      }
  ...
  JsonRestStores.Store.makeAll( app,  '/call/:workspaceIdCall/Options/', ':optionId', OptionsStore );
