...
, db = hotplate.get('db')
, mongoUtils = hotplate.getModule('hotMongoUtils')
;
...
hooks.run = function( done ){
  ...
  var userConfig = new mongoUtils.Config( {
  ...
  app.get( '/call/:workspaceIdCall/userConfig/:userId', mongoUtils.makeGet( userConfig ) );
  app.put( '/call/:workspaceIdCall/userConfig/:userId', mongoUtils.makePut( userConfig ) );


  // Copy userConfig onto a new object
  userConfigNoWorkspace = {};
  for( var k in userConfig ) userConfigNoWorkspace[k] = userConfig[k];
  ...
  app.get( '/call/userConfigNoWorkspace/:userId', mongoUtils.makeGet( userConfigNoWorkspace ) );
  app.put( '/call/userConfigNoWorkspace/:userId', mongoUtils.makePut( userConfigNoWorkspace ) );

  var workspaceConfig = new mongoUtils.Config( {
  ...
  app.get( '/call/:workspaceIdCall/workspaceConfig/:workspaceId', mongoUtils.makeGet( workspaceConfig) );
  app.put( '/call/:workspaceIdCall/workspaceConfig/:workspaceId', mongoUtils.makePut( workspaceConfig) );


  var accessConfig = new mongoUtils.Config( {
  ...
  app.get( '/call/:workspaceIdCall/accessConfig/:userId', mongoUtils.makeGet( accessConfig ) );
  app.put( '/call/:workspaceIdCall/accessConfig/:userId', mongoUtils.makePut( accessConfig ) );
