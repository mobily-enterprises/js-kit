...
define([
  ...
  "hotplate/hotDojoAuth/ValidationUsername",
    ...
    return declare('hotplate.bd.Dashboard', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {
    ...
    var grid = new customGrid({
        ...
        query: {} , //  data: 'pp' },
        query: {errorName: 'ReferenceError' }
    ...
    console.log('CHECK:');
    console.log(stores('workspacesAll'));
