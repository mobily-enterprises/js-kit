...
define([
  ...
  declare('hotplate/bd/UserConfigGeneral', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin ], {
    ...
    templateString: '' +
      ...
      '        <input id="${id}_LocalName" data-dojo-type="dijit/form/ValidationTextBox" style="width:10em;" maxlength="25" name="localName" data-dojo-props="" />' + 
      '      </div>' +
      '      <div class="inputField" style="display:inline-block;">' +
      '        <label for="${id}_LocalLastName">Last Name</label>' +
      '        <input id="${id}_LocalLastName" data-dojo-type="dijit/form/ValidationTextBox" style="width:40em" maxlength="250" name="localLastName" data-dojo-props="" />' +
      '      </div>' +
      '    </div>' +
