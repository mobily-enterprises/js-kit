...
define([
  ...
  return declare('hotplate/bd/UserConfig', [ EditingWidget ], {
    ...
    templateString: jade.compile( '' +
      ...
      '        input(  id="${id}_Email", name="email", data-dojo-type="dijit/form/ValidationTextBox", style="width:30em", maxlength="80", name="email", data-dojo-props="validator:sharedFunctions.hotCommonValidators.email, required:true, invalidMessage:sharedFunctions.hotCommonValidators.email(false)")\n' +
