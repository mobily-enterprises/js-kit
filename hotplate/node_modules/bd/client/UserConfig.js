...
define([
  ...
  var UserConfig = declare('hotplate/bd/UserConfig', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin ], {
    ...
    templateString: '' +
      ...
      '        <input id="${id}_Surname" data-dojo-type="dijit/form/ValidationTextBox" style="width:40em" maxlength="40" name="surname" data-dojo-props="" />' +
      '      </div>' +
    ...
    constructor: function(params){
      ...
      if( globals.inContainer ){
        ...
        this.recordStoreName = 'userConfigNoWorkspace';
      }
