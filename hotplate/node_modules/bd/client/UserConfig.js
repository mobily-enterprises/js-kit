...
define([
  ...
  var UserConfigTabContainer = declare('hotplate/bd/UserConfigTabContainer', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin ], {
    ...
    templateString: '' +
      ...
      '      <div data-dojo-type="hotplate/bd/UserConfigGeneral" data-dojo-props="title:\'General\'"></div>' + 
      '    </div>' +
      '  </div>' +
      '</div>',
  });
  ...
  declare('hotplate/bd/UserConfigGeneral', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin ], {
    ...
    '        <input id="${id}_LocalEmail" data-dojo-type="dijit/form/ValidationTextBox" style="width:40em" maxlength="60" name="localEmail" data-dojo-props="validator:sharedFunctions.hotCommonValidators.email, required:true, invalidMessage:sharedFunctions.hotCommonValidators.email(false)"/>' +
    '      </div>' +
