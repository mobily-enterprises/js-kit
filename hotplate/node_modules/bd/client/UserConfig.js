...
define([
  ...
  var UserConfig = declare('hotplate/bd/UserConfig', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin ], {
    ...
    constructor: function(params){
      ...
      // recordStoreName not defined: defaults to the "normal" userConfig, rendered in
      // the normal appContainer page
      if( typeof( params ) === 'undefined' || typeof( params.recordStoreName ) === 'undefined' ){
        this.recordStoreName = 'userConfig';
        this.userId = vars['hotDojoAppContainer']['userId'];
      }
    ...
    postCreate: function(){
      ...
      this.recordStore = stores( this.recordStoreName );
    ...
    onShow: function(){
      ...
      // userId can come from the cosyness of the appContainer OR it could come
      // from the login screen, before actually entering a workspace (still in picking phase)

      when( this.recordStore.noCache.get( this.userId )).then(
        ds.UIMsg(),
