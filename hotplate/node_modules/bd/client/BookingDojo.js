    ...
    return declare( [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin, _OverlayMixin, _OnDijitClickMixin ], {
      ...
      templateString: '' +
        ...
        gooo2:function(e){
          ...
          ///*
          s.query( { name: 'A', age: 44 }, { start: 0, count: 3, sort: [
          ...
          /*
          s.put( { name: "Andrea", age: 30 } );
          s.put( { name: "Chiara", age: 20  } );
          s.put( { name: "Andrew", age: 43 } );
          s.put( { name: "Massimo", age:44  } );
          s.put( { name: "Anna", age: 30 } );
          s.put( { name: "Annetta", age: 21  } );
          s.put( { name: "Annina", age: 44 } );
          s.put( { name: "Mimi", age:45  } );
          s.put( { name: "Annina", age: 44 } );
          */
