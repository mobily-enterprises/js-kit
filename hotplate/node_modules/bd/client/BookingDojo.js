   ...
   // "app/widgets/SearchPage",
    ...
    return declare( [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin, Destroyable, _OverlayMixin ], {
      ...
      templateString: '' +
        ...
        '       <span data-dojo-attach-event="onclick:gooo" >Booking Dojo</span> <span data-dojo-attach-event="onclick:gooo2">B</span> <span data-dojo-attach-point="userName"></span> <div class="logoutButton" data-dojo-type="hotplate/hotDojoAuth/LogoutButton" data-dojo-props="workspaceName: \'${workspaceName}\'"></div>' +
        '    </div>' +
        ...
        gooo:function(e){
          M = messages;
          // messages.propagate('toEverybody', 'firstMessage', { name: 'Zoe', number: counter++ } );
          messages.propagate('toMyTabs', 'firstMessage', { name: 'Zoe2', number: counter++ } );
        },
        ...
        postCreate:function(){
          ...
          function registerForMessages(){
            messages.register(vars['hotDojoAppContainer']['workspaceId']).then(
              function(res){
          ...
          messages.on('firstMessage', function(message) {
            console.log("AH RECEIVED!");            
            console.log(message);            
          });
