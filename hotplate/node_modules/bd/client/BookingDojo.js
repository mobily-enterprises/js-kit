   ...
   // "app/widgets/SearchPage",
    ...
    return declare( [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin, Destroyable ], {
      ...
      templateString: '' +
        ...
        '      <div data-dojo-attach-point="config" data-dojo-type="hotplate/bd/UserConfig" data-dojo-props="title: \'User Config\'"></div>' +
        '      <div data-dojo-attach-point="admin" data-dojo-type="hotplate/bd/Admin" data-dojo-props="title: \'Admin\'"></div>' +
