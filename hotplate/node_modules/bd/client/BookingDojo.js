   ...
   // "app/widgets/SearchPage",
    ...
    return declare( [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin ], {
      ...
      templateString: '' +
        ...
        '       <p>Booking Dojo</p> <div class="logoutButton" data-dojo-type="hotplate.hotDojoAuth.LogoutButton" data-dojo-props="workspaceName: \'${workspaceName}\'"></div>' +
        '    </div>' +
        ...
        '      <div data-dojo-attach-point="logs" data-dojo-type="hotplate.bd.Logs" data-dojo-props="title: \'Logs\'"></div>' +
        '      <div data-dojo-attach-point="settings" data-dojo-type="hotplate.bd.Settings" data-dojo-props="title: \'Settings\'"></div>' +
