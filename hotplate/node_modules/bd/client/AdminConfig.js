...
define([
  ...
  declare('hotplate/bd/AdminLogs', [ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin ], {
    ...
    onShow: function(){
      ...
      if( !this._shownBefore ){
        ...
        this.grid.set('store', stores('logs', { workspaceIdCall: vars['hotDojoAppContainer']['workspaceId'] }) );
        this.grid.resize();
      }
    },
  ...
  declare('hotplate/bd/AdminWorkspaceSettings', [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _OverlayMixin ], {
    ...
    postCreate: function(){
      ...
      topic.subscribe('configChange/workspace', function(u, message){
    ...
    onShow: function(){
      ...
      when( this.recordStore.noCache.get( workspaceId )).then(
        ds.UIMsg(),
