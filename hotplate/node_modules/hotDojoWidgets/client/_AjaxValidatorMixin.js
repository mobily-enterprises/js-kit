        ...
        if( typeof( this.ajaxResponse[value]) == 'undefined' ){
          ...
          options.ajaxStore.query( filterObject ).then(
            lang.hitch(this, function(res){
              ...
              // the standard)
              //
              // FIXME: It would be better if this didn't depend on hotFixResponse(),
              // which is a global function defined by hotProtocol... all this needs
              // really is the key within the returned object to check.
              goodRes = hotFixResponse(res);
