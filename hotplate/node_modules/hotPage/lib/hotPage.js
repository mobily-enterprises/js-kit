...
HotPage.prototype.hotHooks.postInit = function(){
      ...
      switch( type ) {
        ...
        case 'jses':
          elements.forEach( function(element) { 
            this.jses.add(moduleName, element);
          });
        break;

        case 'csses':
          elements.forEach( function(element) { 
            this.csses.add(moduleName, element);
          });
        break;

        case 'vars':
          elements.forEach( function(element) { 
            this.vars.add(moduleName, element.name, element.value );
          });
        break;
      }
    }
