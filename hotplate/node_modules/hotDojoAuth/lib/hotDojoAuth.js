...
var postWorkspacesAnon = function(req, res, next){
  ...
  hotplate.log("MERC -----------------------");
  hotplate.log(hotplate.getModule('hotSharedCode').sharedFunctions );
  hotplate.log(Validators);
  ...
  if(errors.length){
    ...
    hotplate.log(e.ValidationError); 
    hotplate.log("%j", hotplate.getModule('hotError').errors);
