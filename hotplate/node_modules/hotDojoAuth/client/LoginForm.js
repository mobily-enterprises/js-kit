...
define([
  ...
  "hotplate/hotDojoWidgets/BusyButton",
    ...
    return declare('hotplate.hotDojoAuth.LoginForm', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {
      ...
      postCreate: function(){
        ...
        // TODO: Maybe create this.login like it happens with LogoutButton
        //  If the global variable loginValue is set, then set the login name to
        //  the right value, and focus on the password widget
        if( typeof( vars.hotDojoAuth.login ) != 'undefined' && vars.hotDojoAuth.login != '' ){
