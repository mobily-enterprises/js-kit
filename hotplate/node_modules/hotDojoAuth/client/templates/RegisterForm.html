  ...
  <div data-dojo-type="dijit.layout.StackContainer" data-dojo-attach-point="container" data-dojo-props="doLayout:false" style="height:100%">
    ...
    <div data-dojo-type="dijit.layout.ContentPane" data-dojo-attach-point="registerAsAnon">
      ...
      <form data-dojo-type="dijit.form.Form" data-dojo-attach-point="formAsAnon" method="POST">
        ...
        <input name="workspace" id="${id}_workspace_name" data-dojo-attach-point="workspaceAsAnon" data-dojo-type="hotplate.hotDojoAuth.ValidationWorkspace" data-dojo-props="ajaxOkWhen:'absent', ajaxInvalidMessage:'Workspace taken!'" />
        ...
        <input name="login" id="${id}_login" data-dojo-attach-point="login" data-dojo-type="hotplate.hotDojoAuth.ValidationUsername" data-dojo-props="ajaxOkWhen:'absent', ajaxInvalidMessage:'Username taken!'" />
    ...
    <div data-dojo-type="dijit.layout.ContentPane" data-dojo-attach-point="registerAsUser">
      <div class="registerMessage">
        Hi <strong>${loginValue}</strong>! You are currently logged in. Your workspace will be registered under your existing username, <strong>${loginValue}</strong>. You can <a href="#" data-dojo-attach-event="onclick:_logoutAndSwap">logout</a> if you like!
      </div>
      ...
      <form data-dojo-type="dijit.form.Form" data-dojo-attach-point="formAsUser" method="POST">
        ...
        <input name="workspace" id="${id}_workspace_anon" data-dojo-attach-point="workspaceAsUser" data-dojo-type="hotplate.hotDojoAuth.ValidationWorkspace" data-dojo-props="ajaxOkWhen:'absent', ajaxInvalidMessage:'Workspace taken!'"/>
