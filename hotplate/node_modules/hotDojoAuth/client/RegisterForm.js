define([
  ...
  "hotplate/hotDojoWidgets/BusyButton",
    ...
    return declare('hotplate.hotDojoAuth.RegisterForm', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {

      login: typeof( vars.hotDojoAuth.login ) != 'undefined' ? vars.hotDojoAuth.login : null,
      ...
      postCreate: function(){
        ...
        this.container.selectChild( 
          ( typeof( vars.hotDojoAuth.login ) != 'undefined' && vars.hotDojoAuth.login != '' )
            ? this.registerAsUser 
            : this.registerAsAnon 
        );
        ...
        this.formAsAnon.onSubmit = ds.defaultSubmit(this.formAsAnon, this.buttonAsAnon, function(){
          ...
          stores.workspacesAnon.put(data).then(
            ...
            function(res){
              ...
              window.location = vars.hotplate.afterLoginPage + res.data.workspaceId;
