...
define([
     ...
     "hotplate/hotDojoHooks/SyncSubscriber!hotplate/hotDojoStores/newStore|AppStoreNotify",
     "dojo/domReady!",
   ], function(
   declare
   , topic
  ...
  topic.subscribe( 'hotplate/hotDojoStores/newStore', function( storeName, store ){
    ...
    // The dontPublish flag is there in case you want to shove something into
    // the memCache and don't want the topic to get published
