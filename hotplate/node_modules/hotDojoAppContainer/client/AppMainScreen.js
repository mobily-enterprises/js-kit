define([
  ...
  "dijit/_WidgetsInTemplateMixin",
   ...
   "hotplate/hotDojoAppContainer/Dashboard",
   // "app/widgets/SearchPage",
    ...
    return declare('AppMainScreen', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {
      ...
      templateString: '' +
        ...
        '       Booking Dojo <span data-dojo-type="hotplate.hotDojoAuth.LogoutButton" data-dojo-props="workspaceName: \'${workspaceName}\'"> </span>' +
        '   </div>' +
        '    <div data-dojo-type="dijit.layout.TabContainer" data-dojo-props="region: \'center\', tabPosition: \'left-h\'">' +
        '      <div data-dojo-type="hotplate.hotDojoAppContainer.Dashboard" data-dojo-props="title: \'Dashboard\'">Section One</div>' +
