...
define([
  ...
  var Messages = declare([Evented], {
    ...
    constructor: function(){
      ...
      // starts syncing
      this.timeoutId = setTimeout( lang.hitch(this, this.sync), this.syncInterval );
    },
    ...
    sync: function(){
      ...
      if( this.syncingNow || ! this.workspaceId ){
         return;
      }
      ...
      request('/call/' + this.workspaceId + '/sync/' + this.tabId,
        ...
        function(err){
          ...
          // There was an error: set the next timeout, stop the sinking,
