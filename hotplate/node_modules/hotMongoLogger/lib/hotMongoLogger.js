...
function logs( req, res, next ){
  ...
  resUtils.enrichSelector( req.url, selector, { operator: 'or', partial: { errorName: true } } );
  cursor = logs.find(selector);
  resUtils.enrichCursorSort( req.url, cursor, {} );
  resUtils.enrichCursorRange( req, res, cursor, {}, function( err ){
