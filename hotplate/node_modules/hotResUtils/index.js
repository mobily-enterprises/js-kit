...
Config.prototype.setDocSection = function( req, next, cb ){
  this.docSection = this.fetchedDoc;
  cb();
}

Config.prototype.checkPermissionsGet = function( req, next, cb ){
  cb();
}
Config.prototype.checkPermissionsPut = function( req, next, cb ){
  cb();
}

Config.prototype.prepareDocSectionBeforeSend = function( req, next, cb ){
  cb();
}
...
exports.makePut = function( options ){
  ...
  return function( req, res, next ){
    ...
    // Both these functions will possibly add to `errors`
