...
HotPage.prototype.processPageTemplate = function( elements, callback ) {
  ...
  hotplate.invokeAll('pageElementsPerPage', elements, function(err, results){
...
HotPage.prototype.hotHooks.init = function( done ){
  ...
  this.pageTemplate = replacePageElements( this.pageTemplate, { csses:this.csses, jses:this.jses, vars:this.vars, headLines:this.headLines } );
