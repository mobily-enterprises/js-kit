...
hooks.run = function( done ){
  ...
  hotplate.log("Hook for 'testing' called!");
  ...
  hotplate.invokeAllFlattened('permissions', function( err, results ){
    hotplate.log("Full permission list: %j", results);
    done( null );
  });
...
hooks.clientPaths = function( done ){
  done( null, { moduleName:'hotTestingModule', result: [ path.join(__dirname, 'client') ] } );
}
