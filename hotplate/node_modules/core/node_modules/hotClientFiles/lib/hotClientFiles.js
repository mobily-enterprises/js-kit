...
HotClientFiles.prototype.hotHooks.postInit = function(){

  var that = this;
  var moduleName;

  hotplate.invokeAll('clientPaths').forEach( function(element) {
    moduleName = element.moduleName;
    result = element.result;

    result.forEach( function( clientPath ){
...
HotClientFiles.prototype.serve = function(options){
  ...
  return function static(req, res, next) {
    ...
    // console.log("localLocations is: " + that.localLocations[ match[1] ] );
