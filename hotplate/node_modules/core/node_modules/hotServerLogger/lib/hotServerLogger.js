...
// Define basic, guaranteed  log Fields used by hotPlate
hooks.logFields = function( done ){
  done( null, {
    logLevel:  { type: 'number', index: true, default: 3 },
    errorName: { type: 'string', index: true, default: '' },
    message:   { type: 'string', default: ''},
    data:      { type: 'string', serialize: true, default: '' },
    loggedOn:  { type: 'date',   default: new Date(), index: true },
  } );
}
